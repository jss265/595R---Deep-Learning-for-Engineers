...
class RNNPredictor(nn.Module):
    def __init__(self, input_size=10, hidden_size=128, num_classes=4, num_layers=1, batch_first=True):
        super().__init__()
    ...
    def forward(self, x, lengths):
        lengths = lengths.cpu() # pack_padded_sequence needs lengths to be on the CPU
        
        # Pack the padded tensor so the GRU ignores the zeros
        ...
        # Pass it through the linear classification layer
